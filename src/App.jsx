...
import Base64Decoding from './apps/b64-decoding/B64Decoding';
          ...
          <Route>
            <AppContainer>
              <Switch>
                ...
                <Route path="/b64-decoding" exact component={Base64Decoding} />
                ...
                <Route path="/icon-collection" exact component={IconCollection} />
